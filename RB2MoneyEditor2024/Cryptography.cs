...
namespace RB2MoneyEditor2024.x360
{
    ...
    public sealed class CRC32
    {
        ...
        [CompilerGenerated]
        readonly int[] crctable = new int[256];
        [CompilerGenerated]
        uint crc;
    ...
    public static class ScrambleMethods
    {
        ...
        public static byte[] DJScramble(byte[] xPiece)
        {
            ...
            var xStream = new DJsIO(xPiece, true) { Position = 0 };
    ...
    public static class RSAQuick
    {
        ...
        {
            var xCSP = new CspParameters();
            var xRSA = new RSACryptoServiceProvider(xCSP);
